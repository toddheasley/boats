...
extension DepartureTests {
    ...
    func testDescription() {
        ...
        XCTAssertEqual(Departure(time: Time(hour: 4, minute: 20), deviations: [.start(Date(timeIntervalSince1970: 1540958400.0)), .holiday]).description, "4:20 starts 10/31, except holiday")
        XCTAssertEqual(Departure(time: Time(hour: 16, minute: 20), deviations: [.end(Date(timeIntervalSince1970: 1540958400.0))], services: [.car]).description, "4:20. ends 10/31, car")
...
extension DepartureTests {
    ...
    func testHTMLInit() {
        ...
        XCTAssertEqual(try? Departure(from: "AM4:20 starts 4/20").deviations, [.start(Date(timeIntervalSince1970: 1555732800.0))])
        ...
        XCTAssertEqual(try? Departure(from: "PM4:20 ends 10/31").deviations, [.end(Date(timeIntervalSince1970: 1540958400.0))])
