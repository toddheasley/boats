...
extension DepartureTests {
    ...
    func testDescription() {
        ...
        XCTAssertEqual(Departure(time: Time(hour: 4, minute: 20), deviations: [.start(Date(timeIntervalSince1970: 1540958400.0)), .except(.holiday)]).description, "4:20 started 10/31, except hol")
