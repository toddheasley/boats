...
class DepartureView: UIView, StatusView {
    ...
    private let timeView: TimeView = TimeView(size: .medium)
    ...
    override func intrinsicContentSize() -> CGSize {
        return CGSize(width: 230.0, height: timeView.intrinsicContentSize().height)
    }
    ...
    override init(frame: CGRect) {
        ...
        statusLabel.frame = CGRect(x: 1.0, y: 0.0, width: 38.0, height: 17.0)
        statusLabel.font = .xsmall
